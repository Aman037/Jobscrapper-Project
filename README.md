...
1. **Frontend (Next.js, React, Tailwind CSS)** – User interface for the platform *(my contribution)*  
2. **Backend (Node.js, Express.js)** – Core application logic and services  
3. **API Creation & Management** – Handles data exchange and job fetching  
4. **CI/CD Integration** – Automated deployment & continuous updates  
...
- **Other Tools:** GitHub, Agile methodology, CI/CD pipelines 
